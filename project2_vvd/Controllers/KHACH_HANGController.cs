...
namespace project2_vvd.Controllers
{
    public class KHACH_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,MaKhachHang,HoTenKhachHang,Email,MatKhau,DienThoai,DiaChi,NgayDangKy,TrangThai")] KHACH_HANG kHACH_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,MaKhachHang,HoTenKhachHang,Email,MatKhau,DienThoai,DiaChi,NgayDangKy,TrangThai")] KHACH_HANG kHACH_HANG)
        {
            if (ModelState.IsValid)
            {
